...
<body>
                    ...
                    <ul class="navbar-nav topbar-nav ml-md-auto align-items-center">
                        ...
                        <li class="nav-item dropdown hidden-caret">
                            ...
                            <ul class="dropdown-menu dropdown-user animated fadeIn">
                                <li>
                                    <div class="user-box">
                                        <div class="avatar-lg"><img src="{{Auth::user()->photo}}" alt="image profile"
    ...
    <script src="{{asset("plantillaAdmin/assets/js/plugin/jquery-ui-touch-punch/jquery.ui.touch-punch.min.js")}}">
    </script>
